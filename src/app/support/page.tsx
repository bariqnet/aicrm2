      ...
      <article className="mx-auto w-full max-w-4xl rounded-3xl border border-black/10 bg-white p-6 shadow-[0_10px_30px_rgba(15,18,24,0.06)] sm:p-8">
        <div className="mb-7">
          ...
          <p className="mt-2 text-sm text-black/58">
            {tr(
              "Need help with setup, billing, or workspace issues?",
              "هل تحتاج إلى مساعدة في الإعداد أو الفوترة أو مشاكل مساحة العمل؟",
            )}
          </p>
        </div>
        ...
        >
          <section className="rounded-2xl border border-black/10 bg-[#fafafa] p-5">
            ...
            <p className="mt-2">
              {tr("Email us at", "راسلنا على البريد")}:{" "}
              <a
                href="mailto:support@quecrm.com"
          ...
          <section className="rounded-2xl border border-black/10 bg-[#fafafa] p-5">
            <h2 className="text-lg font-semibold text-black">
              {tr("Typical Response Time", "مدة الاستجابة المتوقعة")}
            </h2>
            <p className="mt-2">
              {tr(
                "Monday to Friday, replies are usually sent within one business day.",
                "من الاثنين إلى الجمعة، نرد عادةً خلال يوم عمل واحد.",
              )}
            </p>
          </section>
          ...
          <section className="rounded-2xl border border-black/10 bg-[#fafafa] p-5">
            <h2 className="text-lg font-semibold text-black">
              {tr("What to Include", "ما الذي يجب تضمينه")}
            </h2>
