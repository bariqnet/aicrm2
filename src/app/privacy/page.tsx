    ...
    <main className="min-h-screen bg-[#f5f6f8] px-5 py-10 text-[#0f1218] sm:px-8 lg:py-14">
      <article className="mx-auto w-full max-w-4xl rounded-3xl border border-black/10 bg-white p-6 shadow-[0_10px_30px_rgba(15,18,24,0.06)] sm:p-8">
        <div className="mb-7">
          ...
          <p className="mt-2 text-sm text-black/58">{tr("Last updated: March 5, 2026", "آخر تحديث: 5 مارس 2026")}</p>
        </div>
        ...
        <div className={isArabic ? "space-y-6 text-[0.98rem] leading-8 text-black/78" : "space-y-6 text-[0.95rem] leading-7 text-black/75"}>
          ...
          <section>
            <h2 className="text-lg font-semibold text-black">{tr("How We Use Data", "كيف نستخدم البيانات")}</h2>
            <p className="mt-2">
              {tr(
          ...
          <section>
            <h2 className="text-lg font-semibold text-black">{tr("Data Sharing", "مشاركة البيانات")}</h2>
            <p className="mt-2">
              {tr(
          ...
          <section>
            <h2 className="text-lg font-semibold text-black">{tr("Retention & Deletion", "الاحتفاظ والحذف")}</h2>
            <p className="mt-2">
              {tr(
